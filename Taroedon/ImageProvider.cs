                    ...
                    using (var webClient = new WebClient())
                    {
                        ...
                        if (bytedata != null && bytedata.Length > 0)
                        {
                            try
                            {
                                ...
                                bitmap = Bitmap.CreateScaledBitmap(bitmap, 100, 100, false);//low pixels
                ...
                try
                {
                    using (var webClient = new WebClient())
                    {
                        ...
                        if (bytedata != null && bytedata.Length > 0)
                        {
                            ...
                            bitmap = Bitmap.CreateScaledBitmap(bitmap, x, y, false);//low pixels
                            BinaryManager.WriteBitmap_To_Map(url, bitmap);//save cache
                            image.SetImageBitmap(bitmap);
                        }
                        else
                        {
